...
ROM:0003800C ; ---------------------------------------------------------------------------
ROM:00038010                 dc.b $D0
ROM:00038011                 dc.b $3C ; <
ROM:00038012                 dc.b   0
ROM:00038013 byte_38013:     dc.b 4                  ; DATA XREF: sub_37A7A+578↑w
ROM:00038014                 dc.b $B0
ROM:00038015                 dc.b $28 ; (
ROM:00038016                 dc.b   0
ROM:00038017                 dc.b $10
ROM:00038018                 dc.b $63 ; c
ROM:00038019                 dc.b   0
ROM:0003801A                 dc.b   0
ROM:0003801B                 dc.b $46 ; F
ROM:0003801C                 dc.b $1A
ROM:0003801D                 dc.b $28 ; (
ROM:0003801E                 dc.b   0
ROM:0003801F                 dc.b   8
ROM:00038020                 dc.b $61 ; a
ROM:00038021                 dc.b   0
ROM:00038022                 dc.b   2
ROM:00038023                 dc.b   0
ROM:00038024                 dc.b $43 ; C
ROM:00038025                 dc.b $F9
ROM:00038026                 dc.b   0
ROM:00038027                 dc.b   3
ROM:00038028                 dc.b $85
ROM:00038029                 dc.b $5E ; ^
ROM:0003802A                 dc.b $D3
ROM:0003802B                 dc.b $F9
ROM:0003802C                 dc.b   0
ROM:0003802D                 dc.b   3
ROM:0003802E                 dc.b $85
ROM:0003802F                 dc.b $C4
ROM:00038030                 dc.b $30 ; 0
ROM:00038031                 dc.b $11
ROM:00038032                 dc.b $45 ; E
ROM:00038033                 dc.b $F9
ROM:00038034                 dc.b   0
ROM:00038035                 dc.b   3
ROM:00038036                 dc.b $85
ROM:00038037                 dc.b $6E ; n
ROM:00038038                 dc.b $4A ; J
ROM:00038039                 dc.b $39 ; 9
ROM:0003803A                 dc.b   0
ROM:0003803B                 dc.b   3
ROM:0003803C                 dc.b $85
ROM:0003803D                 dc.b $5B ; [
ROM:0003803E                 dc.b $67 ; g
ROM:0003803F                 dc.b   0
ROM:00038040                 dc.b   0
ROM:00038041                 dc.b  $A
ROM:00038042                 dc.b $90
ROM:00038043                 dc.b $52 ; R
ROM:00038044                 dc.b $32 ; 2
ROM:00038045                 dc.b $80
ROM:00038046                 dc.b $60 ; `
ROM:00038047                 dc.b   0
ROM:00038048                 dc.b   0
ROM:00038049                 dc.b   6
ROM:0003804A                 dc.b $D0
ROM:0003804B                 dc.b $52 ; R
ROM:0003804C                 dc.b $32 ; 2
ROM:0003804D                 dc.b $80
ROM:0003804E                 dc.b $45 ; E
ROM:0003804F                 dc.b $F9
ROM:00038050                 dc.b   0
ROM:00038051                 dc.b   3
ROM:00038052                 dc.b $84
ROM:00038053                 dc.b $C6
ROM:00038054                 dc.b $D5
ROM:00038055                 dc.b $F9
ROM:00038056                 dc.b   0
ROM:00038057                 dc.b   3
ROM:00038058                 dc.b $85
ROM:00038059                 dc.b $C4
ROM:0003805A                 dc.b $34 ; 4
ROM:0003805B                 dc.b $91
ROM:0003805C                 dc.b $60 ; `
ROM:0003805D                 dc.b   0
ROM:0003805E                 dc.b   0
ROM:0003805F                 dc.b $1C
ROM:00038060                 dc.b $43 ; C
ROM:00038061                 dc.b $F9
ROM:00038062                 dc.b   0
ROM:00038063                 dc.b   3
ROM:00038064                 dc.b $85
ROM:00038065                 dc.b $5E ; ^
ROM:00038066                 dc.b $D3
ROM:00038067                 dc.b $F9
ROM:00038068                 dc.b   0
ROM:00038069                 dc.b   3
ROM:0003806A                 dc.b $85
ROM:0003806B                 dc.b $C4
ROM:0003806C                 dc.b $4D ; M
ROM:0003806D                 dc.b $F9
ROM:0003806E                 dc.b   0
ROM:0003806F                 dc.b   3
ROM:00038070                 dc.b $85
ROM:00038071                 dc.b $66 ; f
ROM:00038072                 dc.b $DD
ROM:00038073                 dc.b $F9
ROM:00038074                 dc.b   0
ROM:00038075                 dc.b   3
ROM:00038076                 dc.b $85
ROM:00038077                 dc.b $C4
ROM:00038078                 dc.b $32 ; 2
ROM:00038079                 dc.b $96
ROM:0003807A ; ---------------------------------------------------------------------------
...
ROM:00038220
ROM:00038220 ; ---------------------------------------------------------------------------
ROM:00038222                 dc.b $18
ROM:00038223                 dc.b $3C ; <
ROM:00038224                 dc.b   0
ROM:00038225 byte_38225:     dc.b $1F                ; DATA XREF: sub_37A7A+568↑w
ROM:00038226                 dc.b $BA
ROM:00038227                 dc.b   4
ROM:00038228                 dc.b $64 ; d
ROM:00038229                 dc.b   0
ROM:0003822A                 dc.b   0
ROM:0003822B                 dc.b $40 ; @
ROM:0003822C                 dc.b $13
ROM:0003822D                 dc.b $FC
ROM:0003822E                 dc.b   0
ROM:0003822F                 dc.b   1
ROM:00038230                 dc.b   0
ROM:00038231                 dc.b   3
ROM:00038232                 dc.b $85
ROM:00038233                 dc.b $5B ; [
ROM:00038234                 dc.b $43 ; C
ROM:00038235                 dc.b $F9
ROM:00038236                 dc.b   0
ROM:00038237                 dc.b   3
ROM:00038238                 dc.b $84
ROM:00038239                 dc.b $64 ; d
ROM:0003823A                 dc.b $D8
ROM:0003823B                 dc.b   4
ROM:0003823C                 dc.b $D3
ROM:0003823D                 dc.b $C4
ROM:0003823E                 dc.b $38 ; 8
ROM:0003823F                 dc.b $11
ROM:00038240                 dc.b $2F ; /
ROM:00038241                 dc.b  $E
ROM:00038242                 dc.b $4D ; M
ROM:00038243                 dc.b $F9
ROM:00038244                 dc.b   0
ROM:00038245                 dc.b   3
ROM:00038246                 dc.b $85
ROM:00038247                 dc.b $66 ; f
ROM:00038248                 dc.b $DD
ROM:00038249                 dc.b $F9
ROM:0003824A                 dc.b   0
ROM:0003824B                 dc.b   3
ROM:0003824C                 dc.b $85
ROM:0003824D                 dc.b $C4
ROM:0003824E                 dc.b $3C ; <
ROM:0003824F                 dc.b $84
ROM:00038250                 dc.b $2C ; ,
ROM:00038251                 dc.b $5F ; _
ROM:00038252                 dc.b $DA
ROM:00038253                 dc.b   5
ROM:00038254                 dc.b $43 ; C
ROM:00038255                 dc.b $F9
ROM:00038256                 dc.b   0
ROM:00038257                 dc.b   3
ROM:00038258                 dc.b $84
ROM:00038259                 dc.b $64 ; d
ROM:0003825A                 dc.b $D3
ROM:0003825B                 dc.b $C5
ROM:0003825C                 dc.b $3A ; :
ROM:0003825D                 dc.b $11
ROM:0003825E                 dc.b $9A
ROM:0003825F                 dc.b $44 ; D
ROM:00038260                 dc.b $33 ; 3
ROM:00038261                 dc.b $C5
ROM:00038262                 dc.b   0
ROM:00038263                 dc.b   3
ROM:00038264                 dc.b $85
ROM:00038265                 dc.b $6E ; n
ROM:00038266                 dc.b $60 ; `
ROM:00038267                 dc.b   0
ROM:00038268                 dc.b   0
ROM:00038269                 dc.b $3A ; :
ROM:0003826A                 dc.b $42 ; B
ROM:0003826B                 dc.b $39 ; 9
ROM:0003826C                 dc.b   0
ROM:0003826D                 dc.b   3
ROM:0003826E                 dc.b $85
ROM:0003826F                 dc.b $5B ; [
ROM:00038270                 dc.b $43 ; C
ROM:00038271                 dc.b $F9
ROM:00038272                 dc.b   0
ROM:00038273                 dc.b   3
ROM:00038274                 dc.b $84
ROM:00038275                 dc.b $64 ; d
ROM:00038276                 dc.b $D8
ROM:00038277                 dc.b   4
ROM:00038278                 dc.b $D3
ROM:00038279                 dc.b $C4
ROM:0003827A                 dc.b $38 ; 8
ROM:0003827B                 dc.b $11
ROM:0003827C                 dc.b $2F ; /
ROM:0003827D                 dc.b  $E
ROM:0003827E                 dc.b $4D ; M
ROM:0003827F                 dc.b $F9
ROM:00038280                 dc.b   0
ROM:00038281                 dc.b   3
ROM:00038282                 dc.b $85
ROM:00038283                 dc.b $66 ; f
ROM:00038284                 dc.b $DD
ROM:00038285                 dc.b $F9
ROM:00038286                 dc.b   0
ROM:00038287                 dc.b   3
ROM:00038288                 dc.b $85
ROM:00038289                 dc.b $C4
ROM:0003828A                 dc.b $3C ; <
ROM:0003828B                 dc.b $84
ROM:0003828C                 dc.b $2C ; ,
ROM:0003828D                 dc.b $5F ; _
ROM:0003828E                 dc.b $DA
ROM:0003828F                 dc.b   5
ROM:00038290                 dc.b $43 ; C
ROM:00038291                 dc.b $F9
ROM:00038292                 dc.b   0
ROM:00038293                 dc.b   3
ROM:00038294                 dc.b $84
ROM:00038295                 dc.b $64 ; d
ROM:00038296                 dc.b $D3
ROM:00038297                 dc.b $C5
ROM:00038298                 dc.b $3A ; :
ROM:00038299                 dc.b $11
ROM:0003829A                 dc.b $98
ROM:0003829B                 dc.b $45 ; E
ROM:0003829C                 dc.b $33 ; 3
ROM:0003829D                 dc.b $C4
ROM:0003829E                 dc.b   0
ROM:0003829F                 dc.b   3
ROM:000382A0                 dc.b $85
ROM:000382A1                 dc.b $6E ; n
ROM:000382A2                 dc.b $78 ; x
ROM:000382A3                 dc.b   0
ROM:000382A4                 dc.b $18
ROM:000382A5                 dc.b $39 ; 9
ROM:000382A6                 dc.b   0
ROM:000382A7                 dc.b   3
ROM:000382A8                 dc.b $85
ROM:000382A9                 dc.b $54 ; T
ROM:000382AA                 dc.b $70 ; p
ROM:000382AB                 dc.b   0
ROM:000382AC                 dc.b $D0
ROM:000382AD                 dc.b $3C ; <
ROM:000382AE                 dc.b   0
ROM:000382AF byte_382AF:     dc.b 4                  ; DATA XREF: sub_37A7A+57E↑w
ROM:000382B0                 dc.b $51 ; Q
ROM:000382B1                 dc.b $CC
ROM:000382B2                 dc.b $FF
ROM:000382B3                 dc.b $FA
ROM:000382B4                 dc.b $78 ; x
ROM:000382B5                 dc.b   0
ROM:000382B6                 dc.b $7A ; z
ROM:000382B7                 dc.b   0
ROM:000382B8                 dc.b $3A ; :
ROM:000382B9                 dc.b $39 ; 9
ROM:000382BA                 dc.b   0
ROM:000382BB                 dc.b   3
ROM:000382BC                 dc.b $85
ROM:000382BD                 dc.b $6E ; n
ROM:000382BE                 dc.b $8A
ROM:000382BF                 dc.b $C0
ROM:000382C0                 dc.b $33 ; 3
ROM:000382C1                 dc.b $C5
ROM:000382C2                 dc.b   0
ROM:000382C3                 dc.b   3
ROM:000382C4                 dc.b $85
ROM:000382C5                 dc.b $6E ; n
ROM:000382C6                 dc.b $4E ; N
ROM:000382C7                 dc.b $75 ; u
ROM:000382C8
